...
export class SeedConfig {
    ...
    NPM_ASSETS: InjectableDependency[] = [
        {src: 'bootstrap/dist/css/bootstrap.css', inject: true, vendor: true}
    ];
    ...
    get DEPENDENCIES(): InjectableDependency[] {
        ...
        // .concat(normalizeDependencies(this.NPM_ASSETS.filter(filterDependency.bind(null, this.ENV))))
